"""
Tensor AddAssign (+=) Broadcast Reference Test

Test cases for += operation with broadcasting.
Rule: a += b succeeds if b can broadcast to a's shape WITHOUT changing a's shape.
...
def test_add_assign(shape_a, shape_b):
    """
...
def main():
    ...
    test_cases = [
        ...
        ((2, 3), (1, 3), "matrix += row vector"),
        ((3, 4), (4,), "Linear bias: [batch,out] += [out]"),
        ((3, 4), (1, 4), "Linear bias: [batch,out] += [1,out]"),
        ((2, 3, 4), (4,), "3D += 1D"),
        ((2, 3, 4), (3, 4), "3D += 2D"),
        ...
        ((2, 3), (4,), "FAIL: incompatible last dim"),
    ...
    for shape_a, shape_b, desc in test_cases:
        result = test_add_assign(shape_a, shape_b)
...
///
/// Reference: tests/python/tensor_reference/tensor_add_assign_broadcast_reference.py
#[test]
