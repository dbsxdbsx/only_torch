...
mod var_init; // Init 参数初始化策略测试 // LR 调度器测试（CosineAnnealingLR, StepLR, LambdaLR）
...
mod layer_positional;
mod layer_rms_norm;
mod layer_rnn;
mod layer_transformer;
mod mode_cache;
mod model_save;
