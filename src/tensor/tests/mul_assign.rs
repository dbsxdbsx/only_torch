...
///
/// 参考脚本: tests/python/tensor_reference/tensor_mul_assign_broadcast_reference.py
#[test]
fn test_mul_assign_broadcast() {
    ...
    let test_cases: &[(&[usize], &[f32], &[usize], &[f32], &[f32])] = &[
        ...
        (
            ...
            &[1.0, 2.0, 3.0],
            &[
                1.0, 2.0, 3.0, 4.0, 10.0, 12.0, 14.0, 16.0, 27.0, 30.0, 33.0, 36.0,
            ],
        ),
    ];
...
fn test_mul_assign_broadcast_fail_scalar_to_vector() {
...
#[test]
#[should_panic(expected = "张量形状不兼容")]
fn test_mul_assign_broadcast_fail_vector_to_matrix() {
...
#[test]
#[should_panic(expected = "张量形状不兼容")]
fn test_mul_assign_broadcast_fail_incompatible_last_dim() {
