...
#[test]
fn test_div_assign_scalar_or_ref_to_tensor_or_ref() {
    let number = 2.;
    ...
    let test_cases = vec![
        ...
        TensorCheck {
            ...
            expected_output: vec![vec![0.5, 1., 1.5, 2., 2.5, 3.]],
        },
        // 高阶张量
        TensorCheck {
...
#[test]
#[should_panic(
    expected = "形状不一致，故无法相除：第一个张量的形状为[3]，第二个张量的形状为[2]"
)]
