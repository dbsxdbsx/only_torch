...
class Saver(object):
    ...
    def _save_model_and_weights(
        self, graph, meta, service, model_file_name, weights_file_name
    ):
    ...
    def create_node(graph, from_model_json, node_json):
        ...
        if node_type == "Variable":
            ...
            dim = tuple(dim)
            return ClassMining.get_instance_by_subclass_name(Node, node_type)(
                *parents, dim=dim, name=node_name, **kargs
            )
        else:
            return ClassMining.get_instance_by_subclass_name(Node, node_type)(
    ...
    def load(
        ...
        print(
            "Load and restore model from {} and {}".format(
