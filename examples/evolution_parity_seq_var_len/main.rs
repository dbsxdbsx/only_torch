...
fn main() {
    ...
    // 可视化演化后的计算图
    let vis = result.visualize("examples/evolution_parity_seq_var_len/evolution_parity_seq_var_len")
        .expect("可视化失败");
    ...
    // ==================== 模型保存/加载 ====================
    let model_path = "examples/evolution_parity_seq_var_len/parity_seq_var_len_model";
