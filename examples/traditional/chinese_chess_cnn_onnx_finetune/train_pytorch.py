...
用法:
    ...
    # 自定义参数
    python examples/traditional/chinese_chess_cnn_onnx_finetune/train_pytorch.py --epochs 80 --lr 0.001 --batch-size 128
"""
...
def load_data(synthetic_dir, split="train"):
    ...
    Args:
        synthetic_dir: 合成数据根目录 (data/chinese_chess_cnn_onnx_finetune/)
        split: "train" or "test"
...
def main():
    ...
    parser.add_argument("--data", type=str, default="data/chinese_chess_cnn_onnx_finetune",
                        help="合成数据根目录")
