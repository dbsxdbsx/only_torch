...
下载与解压的中间产物放在 D:/DATA/BaiduSyncdisk/project/personal/test_repo/，
最终模型文件放在 only_torch/models/vinxiangqi.onnx（已被 .gitignore 排除）。
...
# 中间下载/解压区（按用户规则，第三方资料不放项目内）
TEST_REPO_DIR = Path("D:/DATA/BaiduSyncdisk/project/personal/test_repo")
ZIP_PATH = TEST_REPO_DIR / f"VinXiangQi.{VINXIANGQI_VERSION}.zip"
EXTRACT_DIR = TEST_REPO_DIR / f"VinXiangQi.{VINXIANGQI_VERSION}_extracted"
