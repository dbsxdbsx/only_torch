...
| [evolution_overlapping_shapes_unet_lite_segmentation](examples/evolution/overlapping_shapes_unet_lite_segmentation/) | **分割 benchmark 演化** | **64x64 U-Net-lite 对照任务**、encoder-decoder 初始族、多类别 Mean IoU、可视化 target/prediction | 自动演化 | `cargo run --example evolution_overlapping_shapes_unet_lite_segmentation` |
