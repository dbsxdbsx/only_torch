...
| 问题 | 状态 | 说明 |
|---|---|---|
| MNIST 准确率上限 ~91.5% | ✅ 已修复 | 阶段 A 已完成全部修复：Conv-BN-ReLU 层块、Conv2d+Pool2d 种子、stride 变异、SizeConstraints 空间域调优、Conv2d resize 修复 |
...
*本文档描述 only_torch 的神经架构演化模块实际实现。最后更新：2026-04-27（v15: 明确 evolution 当前为单输出任务 API；将多输出 / 多头任务演化加入阶段 D roadmap，并记录 FM 显式输出选择的设计边界）*
