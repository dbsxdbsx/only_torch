...
- [SAC 数学基础分析](../../examples/traditional/sac/sac_mathematical_foundations.md) — SAC 各变体的收敛性、KL 散度方向、测度论等理论深度分析
- [Beta 分布备选方案](../../examples/traditional/sac/beta_distribution_note.md) — 有界分布替代 Gaussian+tanh 的理论优势
